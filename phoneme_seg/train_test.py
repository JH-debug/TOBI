...
from eval import PrecisionRecallMetric
from dataloader import construct_mask
from model import get_features
from utils import load_from_checkpoint, save_checkpoint, get_optimizer
    ...
    for e in range(cfg.epochs):
        ...
        for i, samp in enumerate(trainloader):
            ...
            if cfg.val_interval and global_step % cfg.val_interval == cfg.val_interval - 1:
                logger.info(
                    "MODEL VALIDATION: Epoch: {}/{} | Batch: {}/{}".format(e + 1, cfg.epochs, i + 1, len(trainloader)))
