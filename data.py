...
class TokenClassificationDataModule(TransformerDataModule):
    ...
    def __init__(self, *args, data_type: str = "grapheme", label_all_tokens: bool = False, **kwargs) -> None:
        self.labels = None
    ...
    def _setup_input_fields(self, dataset, stage):
        ...
        if self.data_type == "grapheme":
            ...
            text_column_name = "phoneme" if "phoneme" in column_names else column_names[0]
